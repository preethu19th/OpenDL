...
public final class LR extends SGDBase {
    ...
    private class PredictSpark implements Function<SampleVector, SampleVector> {
		private static final long serialVersionUID = 1L;
    ...
    /*
	@Override
	protected double loss(Iterable<SampleVector> samples) {
		DoubleMatrix x_samples = MathUtil.convertX2Matrix(samples,false);
